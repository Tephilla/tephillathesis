...
%places and transitions for request granted scenarios		
		...
		%transition exit
		\node[transition,minimum height=.4cm,minimum width=.4cm,label=left:{$t_{exit}$},below=of p2] (t2){}
...
%request rejected scenarios		
		...
		\node[transition,minimum height=.4cm,minimum width=.4cm,label=right:{$t_{rej\_sink}$},below= of p6] (t5) {}
