...
\begin{frame}
\centering
\includegraphics[width=0.6\textwidth]{figures/sdlc}
\end{frame}
...
\begin{frame}\frametitle{Part 1: Modelling an Unbounded Client-Server (UCS) \colorbox{green!30}{using Petri Nets}}
...
%EOS Keynote slides
\begin{frame}{What are EOSs?}
\includegraphics[width=0.95\textwidth]{part3slides/1}
\end{frame}



\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/2}
\end{frame}


\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/3}
\end{frame}

\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/4}
\end{frame}

\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/5}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/6}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/7}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/8}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/9}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/10}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/11}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/12}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/13}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/14}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/15}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/16}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/17}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/18}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/19}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/20}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/21}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/22}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/23}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/24}
\end{frame}
\begin{frame}
\includegraphics[width=0.95\textwidth]{part3slides/25}
\end{frame}
...
Bounded Model Checking for Unbounded Client Server Systems. Arxiv (2022)
...
\item   Francesco Di Cosmo, Soumodev Mal, Tephilla Prince:
...
\begin{frame}{List of publications (ongoing):}
\begin{enumerate}
   
\item[5] Francesco Di Cosmo, Soumodev Mal, Tephilla Prince: Decidability and Complexity of Reachability and Coverability in Lossy EOS (Under review at TopNOC)

\item[6] Ramchandra Phawade, Tephilla Prince, S. Sheerazuddin:
Bounded Model Checking for Unbounded Client Server Systems. (Yet to be submitted to TopNOC)

\item[7] Ramchandra Phawade, Tephilla Prince, S. Sheerazuddin:
A Monodic Logic for Verifying Unbounded Client-Server Systems (yet to be submitted)
