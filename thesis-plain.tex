...
\input{chapters/ch2_models}
\input{chapters/ch3_logics}
\input{chapters/ch4_problem}
\input{chapters/ch5_LTLTool}
\input{chapters/ch6_FOTool}

\begin{subappendices}
   \clearpage
   \input{chapters/appch6}
\end{subappendices}
\input{chapters/ch7_EOS}
\input{chapters/ch8_concl}
