...
\begin{enumerate}
      \item Why is the work on DCModelchecker1.0 and DCModelchecker2.0 not published? What could you do to make it publishable?
            \answer{ One of the difficulties is that DCModelChecker1.0 and DCModelChecker2.0 are not as fast as the other state of the art tools. Our tools also maintain and print the counterexample traces which takes significant time. We have improved the tool confidence and we have submitted the papers (along with the tools) to journals and await their response.}
