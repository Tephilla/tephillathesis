...
\begin{frame}{Experimental Results}
    ...
    \begin{enumerate}
        \item  the correctness of results returned by DCModelChecker 2.0 in comparison with the state-of-the-art ITS-Tools, obtaining tool confidence 0.94, 6 false positives out of 320 tests.
