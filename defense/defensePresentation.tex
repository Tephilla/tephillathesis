...
\begin{frame}{List of publications:}
    \begin{enumerate}
        ...
        \item[6] Francesco Di Cosmo, Soumodev Mal, Tephilla Prince: Decidability and Complexity of Reachability and Coverability in Lossy EOS (Yet to be submitted)
...
\begin{frame}{List of tools built}
    \begin{enumerate}
        ...
        \item DCModelChecker1.0 verifies PN over {\LC} with interleaved semantics \url{https://doi.org/10.5281/zenodo.7084996}
        \item DCModelChecker2.0 verifies PN over {\LC} allowing concurrent semantics \url{https://doi.org/10.5281/zenodo.7198485}
        \item UCSChecker verifies $\nu$-nets over {\Lstar} properties \url{https://doi.org/10.5281/zenodo.15847737}
        \item NWN Telingo Analyser: verifies lossy and perfect PN and EOSs over LTL properties \url{https://doi.org/10.5281/zenodo.11401876}
    \end{enumerate}
