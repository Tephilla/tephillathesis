...
inner ysep={(height("#1")+8pt)/2}, label={[anchor=north,font=\itshape]north:#1}}]
	...
	\node [ node distance=2em, below of=property, yshift=-1em, fill=green!20] (sysdesc) {Abstract Model};

	\node [alblock, node distance=7em, right of=property, xshift=4em, minimum width=4em] (tool) {BMC Module};

	
	\node [allibrary, right of= tool,xshift=1em,rotate=90](z3){SAT/SMT Solver};
	...
	\path [line] (sysdesc) -- (tool);
	\path [line] (property) -- (tool);
