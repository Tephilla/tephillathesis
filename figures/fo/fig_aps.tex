...
sep=0pt,minimum height=.40cm, minimum width=.5cm] (p2) at (-1,-6){} ;	
		...
		\node[place,label=below:{\small $p_{RG}$},draw=red!50,fill=green!20,inner
...
sep=0pt,minimum height=.40cm, minimum width=.5cm] (p4) at (-1,-10){} ;			
		...
		\node[place,label=below:{\small $p_{DP}$},draw=red!50,fill=green!20,inner
...
sep=0pt,minimum height=.40cm, minimum width=.5cm] (p6) at (1.5,-6){} ;
		...
		\node[place,label=below:{\small $p_{RR}$},draw=red!50,fill=blue!20,inner
