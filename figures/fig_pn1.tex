...
sep=0pt,minimum height=.40cm, minimum width=.5cm] (p0) at (-8,0){} ;	
...
sep=0pt,minimum height=.40cm, minimum width=.5cm, tokens=1] (p1) at (-4,2){} ;
	
\node[place,label=below:{\small $p_{2}$},draw=red!50,inner
sep=0pt,minimum height=.40cm, minimum width=.5cm, tokens=1] (p2) at (-4,-2){} ;
